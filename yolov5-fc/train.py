...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if RANK in [-1, 0]:
            ...
            # Stop DDP TODO: known issues shttps://github.com/ultralytics/yolov5-fc/pull/4576
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/mydatacoco.yaml', help='dataset.yaml path')
